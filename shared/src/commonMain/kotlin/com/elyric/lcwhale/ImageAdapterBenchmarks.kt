...
internal class ImageAdapterStandardTest : BasePager() {
    ...
    override fun created() {
        ...
        mcm.cacheImage("https://vfiles.gtimg.cn/wuji_dashboard/wupload/xy/starter/21e7b9c2.png", false) {
            if (it.state == "Complete" && it.errorCode == 0) {
                httpCache = ImageRef(it.cacheKey)
                httpCacheReady = true
            }
        }
        mcm.cacheImage("https://vfiles.gtimg.cn/wuji_dashboard/wupload/xy/starter/2963d536.gif", false) {
            if (it.state == "Complete" && it.errorCode == 0) {
